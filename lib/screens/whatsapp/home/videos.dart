...
class VideoListViewState extends State<VideoListView> {
  ...
  Widget build(BuildContext context) {
    if (!Directory(_videoDir.path).existsSync()) {
      return Scaffold(
        appBar: AppBar(
          title: const Text("Whatsapp Video Status"),
        ),
        body: Container(
...
class VideoGrid extends StatefulWidget {
  ...
  const VideoGrid({super.key, required this.directory});
            ...
            return Container(
              ...
              child: InkWell(
                onTap: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          PlayStatusVideo(videoFile: videoList[index])),
                ),
                child: FutureBuilder(
